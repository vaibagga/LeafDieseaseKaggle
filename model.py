from DataUtil import LeafDiseaseDataset, train_val_dataset
...
class LeafDiseaseClassifier():
    ...
    def loadModel(self, PATH='resnet.pt'):
    ...
    def predictImagePath(self, image_path):
...
def main():
    ...
    model.loadModel()
    print(model.predictImagePath('Data/test_images/2216849948.jpg'))
